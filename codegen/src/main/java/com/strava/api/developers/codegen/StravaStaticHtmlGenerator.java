package com.strava.api.developers.codegen;
...
public class StravaStaticHtmlGenerator extends DefaultCodegen implements CodegenConfig {
  ...
  public StravaStaticHtmlGenerator() {
    super();
    outputFolder = "docs";
    embeddedTemplateDir = templateDir = "strava-html";
    ...
    supportingFiles.add(new SupportingFile("reference.mustache", "reference.html"));
